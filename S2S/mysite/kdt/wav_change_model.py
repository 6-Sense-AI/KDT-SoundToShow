...
def wave_change(input_name, output_name, st_mel, end_mel, input_dir, output_dir):
    ...
    # 음악 파일을 로드합니다.
    data,sr = librosa.load(f'{input_dir}\\{input_name}')
    ...
    # 음원을 저장합니다.
    sf.write(f'{output_dir}\\{output_name}', y_, samplerate=sr)